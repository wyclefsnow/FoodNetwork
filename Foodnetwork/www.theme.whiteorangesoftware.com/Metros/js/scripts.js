var Omnibubble = Omnibubble || {};

(function($){
	"use strict";

	Omnibubble.initialize = {

		init: function() {
			Omnibubble.initialize.scrollToTop();
			Omnibubble.initialize.slickCarousel();
			Omnibubble.initialize.navbarSearch();
			Omnibubble.initialize.mobileNavigation();
			Omnibubble.initialize.lightboxPopup();
			Omnibubble.initialize.pricingSwitcher();
			Omnibubble.initialize.accordions();
			Omnibubble.initialize.tabs();
			Omnibubble.initialize.stickySocials();
			Omnibubble.initialize.detectBrowserWidth();
			Omnibubble.initialize.detectMobile();
			Omnibubble.initialize.detectIE();
		},
	...
	Omnibubble.documentOnReady = {

		init: function() {
			Omnibubble.initialize.init();
		}

	};

	Omnibubble.windowOnLoad = {

		init: function() {
			Omnibubble.initialize.preloader();
			Omnibubble.initialize.triggerResize();
		}

	};

	Omnibubble.windowOnResize = {

		init: function() {
			Omnibubble.initialize.containerFullHeight();
		}

	}

	Omnibubble.windowOnScroll = {

		init: function() {
			Omnibubble.initialize.scrollToTopScroll();
			Omnibubble.initialize.stickyNavbar();
		}
	...
	$(document).ready(Omnibubble.documentOnReady.init);
	$window.on('load', Omnibubble.windowOnLoad.init);
	$window.on('resize', Omnibubble.windowOnResize.init);
	$window.on('scroll', Omnibubble.windowOnScroll.init);
